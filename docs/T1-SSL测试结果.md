...
|---------|-------|-----------|--------|---------|-------|---------|-------------|
| Echo 压测 | 10 | 200 | 65,536 B | 2,000 | 0 | 165 | 1,515.15 |

### 压测结果（最新，本地环回，kqueue，优化 1~4 后）
| 测试场景 | 连接数 | 每连接请求 | payload | 完成请求 | 错误数 | 耗时(ms) | QPS | 吞吐量(MB/s) |
|---------|-------|-----------|--------|---------|-------|---------|-----|-------------|
| 小包 QPS | 200 | 500 | 47 B | 100,000 | 0 | 792 | 126,263 | 11.32 |
| 大包吞吐 | 10 | 200 | 65,536 B | 2,000 | 0 | 165 | 12,121 | 1,515.15 |
